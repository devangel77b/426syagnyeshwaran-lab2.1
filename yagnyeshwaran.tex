...
% set PDF metadata
\hypersetup{%
pdftitle={Verifying F=ma},
pdfauthor={Sagarika Yagnyeshwaran, Emily Chen, Andrew Kabatsky, Aleksandra Guimaraes, Vijita Ayyangar, and Aryanna Cetrulo},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 31--33 (2024)}
\fancyhead[LO]{Yagnyeshwaran et al.}
\fancyhead[LE]{Verifying $\sum\vec{F}=m\vec{a}$}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 31--33 (2024)}
\fancyfoot[C]{\thepage}
}
